...
bed_path<-paste0(data_dir, "padjust_prebulk_cortex_250k.bedGraph")
dist_path<-paste0(data_dir, "dist_prebulk_cortex_250k.bedGraph")

data_path<-paste0(data_dir,"compartment_raw_ori_pc1_shap_chord.csv")
